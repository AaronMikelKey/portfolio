...
const Projects = () => {
	...
	return (
		<div className="container-p">
			...
			<a
				href="https://personal-sunrise-test.herokuapp.com/"
				target="_blank"
				className="p4"
			>
				...
				<p className="description">
					This was a group project for a member who wanted to create a website
					for his rental property. This app allows you to view info about the
					property, view available dates, and request a reservation. It also
					allows the owner to confirm reservations and add them to the calendar.
